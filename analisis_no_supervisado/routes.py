...
# Añadir esta función al archivo analisis_no_supervisado/routes.py

@analisis_no_supervisado_bp.route('/iframe', methods=['GET', 'POST'])
def iframe():
    """Versión para iframe del análisis no supervisado"""
    if request.method == 'GET':
        return render_template('analisis_no_supervisado_iframe.html')
